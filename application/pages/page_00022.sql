...
wwv_flow_imp_page.create_page(
 p_id=>22
,p_name=>'Anagrafiche di Magazzino'
,p_alias=>'ANAGRAFICHE-DI-MAGAZZINO'
,p_step_title=>'Anagrafiche di magazzino'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
,p_page_component_map=>'06'
,p_last_updated_by=>'MARCO.DIPAOLA'
,p_last_upd_yyyymmddhh24miss=>'20230412163812'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(173058992569945930)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(230522011372081161)
,p_plug_name=>'Menu'
...
,p_list_id=>wwv_flow_imp.id(57712088841450586)

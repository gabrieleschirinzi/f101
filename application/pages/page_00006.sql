...
,p_last_upd_yyyymmddhh24miss=>'20230417122918'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(31589247818912702)
,p_plug_name=>'Zone'
...
,p_prn_page_header=>'Zone'
);
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(31589354857912702)
,p_name=>'Zone'
...
,p_detail_link=>'f?p=&APP_ID.:7:&APP_SESSION.::&DEBUG.:RP:P7_CODZON:\#CODZON#\'
...
,p_internal_uid=>31589354857912702
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(31589778936912703)
,p_db_column_name=>'CODZON'
,p_display_order=>0
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(31590172944912703)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(31595740174934281)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'315958'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'CODZON:DESCR'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(31592327709912705)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(31590612507912703)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(31589247818912702)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(31590905167912704)
,p_name=>'Modifica report - Finestra di dialogo chiusa'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(31589247818912702)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(31591477476912704)
,p_event_id=>wwv_flow_imp.id(31590905167912704)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(31589247818912702)
);

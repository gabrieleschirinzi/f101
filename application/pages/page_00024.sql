...
wwv_flow_imp_page.create_page(
 p_id=>24
,p_name=>'Anagrafiche di Produzione'
,p_alias=>'ANAGRAFICHE-DI-PRODUZIONE'
,p_step_title=>'Anagrafiche di Produzione'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
,p_page_component_map=>'06'
,p_last_updated_by=>'MARCO.DIPAOLA'
,p_last_upd_yyyymmddhh24miss=>'20230412163637'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(288659057455109223)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(346122076257244454)
,p_plug_name=>'Menu'
...
,p_list_id=>wwv_flow_imp.id(57781023764037439)

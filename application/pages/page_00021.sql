...
,p_name=>'Magazzino'
,p_alias=>'MAGAZZINO'
,p_step_title=>'Magazzino'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
,p_page_component_map=>'06'
,p_last_updated_by=>'MARCO.DIPAOLA'
,p_last_upd_yyyymmddhh24miss=>'20230412163753'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115349392358528416)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(172812411160663647)
,p_plug_name=>'Menu'
...
,p_list_id=>wwv_flow_imp.id(57693574072371704)

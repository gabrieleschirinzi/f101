...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(22130335741170318)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22130676691170325)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22130954048170326)
,p_page_template_id=>wwv_flow_imp.id(22130335741170318)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22131207167170326)
,p_page_template_id=>wwv_flow_imp.id(22130335741170318)

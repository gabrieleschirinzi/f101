...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(22212436091170384)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22212796607170384)
,p_plug_template_id=>wwv_flow_imp.id(22212436091170384)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22213066133170385)
,p_plug_template_id=>wwv_flow_imp.id(22212436091170384)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22213367612170385)
,p_plug_template_id=>wwv_flow_imp.id(22212436091170384)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22213623583170385)
,p_plug_template_id=>wwv_flow_imp.id(22212436091170384)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22213903478170385)
,p_plug_template_id=>wwv_flow_imp.id(22212436091170384)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22214252241170385)
,p_plug_template_id=>wwv_flow_imp.id(22212436091170384)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22214593855170385)
,p_plug_template_id=>wwv_flow_imp.id(22212436091170384)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22214897713170385)
,p_plug_template_id=>wwv_flow_imp.id(22212436091170384)
,p_name=>'Sub Regions'

...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(22236671375170397)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22236921533170397)
,p_plug_template_id=>wwv_flow_imp.id(22236671375170397)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22237237830170397)
,p_plug_template_id=>wwv_flow_imp.id(22236671375170397)
,p_name=>'Tabs'

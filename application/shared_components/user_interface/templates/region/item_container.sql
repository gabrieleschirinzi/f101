...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(22219179763170388)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22219427621170388)
,p_plug_template_id=>wwv_flow_imp.id(22219179763170388)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22219702303170388)
,p_plug_template_id=>wwv_flow_imp.id(22219179763170388)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22220024282170388)
,p_plug_template_id=>wwv_flow_imp.id(22219179763170388)
,p_name=>'Button Start'

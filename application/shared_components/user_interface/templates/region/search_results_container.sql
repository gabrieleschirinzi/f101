...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(22224158785170390)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22224467276170390)
,p_plug_template_id=>wwv_flow_imp.id(22224158785170390)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22224748079170391)
,p_plug_template_id=>wwv_flow_imp.id(22224158785170390)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22225047135170391)
,p_plug_template_id=>wwv_flow_imp.id(22224158785170390)
,p_name=>'Sub Regions'

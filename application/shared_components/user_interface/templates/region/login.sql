...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(22221659313170389)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22221923179170389)
,p_plug_template_id=>wwv_flow_imp.id(22221659313170389)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22222218878170389)
,p_plug_template_id=>wwv_flow_imp.id(22221659313170389)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22222501857170389)
,p_plug_template_id=>wwv_flow_imp.id(22221659313170389)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22222881932170390)
,p_plug_template_id=>wwv_flow_imp.id(22221659313170389)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22223192521170390)
,p_plug_template_id=>wwv_flow_imp.id(22221659313170389)
,p_name=>'Sub Regions'

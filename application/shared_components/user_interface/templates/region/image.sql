...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(22202419222170379)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22202787611170379)
,p_plug_template_id=>wwv_flow_imp.id(22202419222170379)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22203042153170379)
,p_plug_template_id=>wwv_flow_imp.id(22202419222170379)
,p_name=>'Sub Regions'

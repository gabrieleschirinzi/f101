...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(22199275461170377)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22199500449170378)
,p_plug_template_id=>wwv_flow_imp.id(22199275461170377)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22199812062170378)
,p_plug_template_id=>wwv_flow_imp.id(22199275461170377)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22200141862170378)
,p_plug_template_id=>wwv_flow_imp.id(22199275461170377)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22200484530170378)
,p_plug_template_id=>wwv_flow_imp.id(22199275461170377)
,p_name=>'Sub Regions'

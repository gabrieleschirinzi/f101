...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(22185120278170369)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22185490936170369)
,p_plug_template_id=>wwv_flow_imp.id(22185120278170369)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22185763840170370)
,p_plug_template_id=>wwv_flow_imp.id(22185120278170369)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22186018127170370)
,p_plug_template_id=>wwv_flow_imp.id(22185120278170369)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22186337176170370)
,p_plug_template_id=>wwv_flow_imp.id(22185120278170369)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22186651639170370)
,p_plug_template_id=>wwv_flow_imp.id(22185120278170369)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22186999524170370)
,p_plug_template_id=>wwv_flow_imp.id(22185120278170369)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22187243249170370)
,p_plug_template_id=>wwv_flow_imp.id(22185120278170369)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22187543718170370)
,p_plug_template_id=>wwv_flow_imp.id(22185120278170369)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22187820453170370)
,p_plug_template_id=>wwv_flow_imp.id(22185120278170369)
,p_name=>'Sub Regions'

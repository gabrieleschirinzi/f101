...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(22173388707170362)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22173603154170362)
,p_plug_template_id=>wwv_flow_imp.id(22173388707170362)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22173913435170362)
,p_plug_template_id=>wwv_flow_imp.id(22173388707170362)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(22174285133170362)
,p_plug_template_id=>wwv_flow_imp.id(22173388707170362)
,p_name=>'Sub Regions'
